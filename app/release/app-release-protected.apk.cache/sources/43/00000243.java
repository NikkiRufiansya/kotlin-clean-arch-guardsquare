...
public final class SearchView extends setCompatElevation {
    ...
    private static double MenuHostHelper$$ExternalSyntheticLambda0(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
        double d10 = d * d6;
    ...
    private static double MenuHostHelper$$ExternalSyntheticLambda1(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d2 * 6.0d;
        double d9 = 3.0d * d;
    ...
    public SearchView(double[] dArr, double[][] dArr2) {
        int length = dArr.length;
        int length2 = dArr2[0].length;
        this.setX = new double[length2];
        int i = length - 1;
        ...
        this.MenuHostHelper$$ExternalSyntheticLambda0 = dArr4;
    }

    @Override // o.setCompatElevation
    public final void setX(double d, double[] dArr) {
        double[] dArr2 = this.setY;
        ...
        if (this.setIconTintList) {
            double d2 = dArr2[0];
            if (d <= d2) {
                MenuHostHelper$$ExternalSyntheticLambda1(d2, this.setX);
                for (int i2 = 0; i2 < length2; i2++) {
                    dArr[i2] = this.MenuHostHelper$$ExternalSyntheticLambda1[0][i2] + ((d - this.setY[0]) * this.setX[i2]);
                }
                return;
            }
            int i3 = length - 1;
            double d3 = dArr2[i3];
            if (d >= d3) {
                MenuHostHelper$$ExternalSyntheticLambda1(d3, this.setX);
                while (i < length2) {
                    dArr[i] = this.MenuHostHelper$$ExternalSyntheticLambda1[i3][i] + ((d - this.setY[i3]) * this.setX[i]);
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr5 = this.MenuHostHelper$$ExternalSyntheticLambda0;
                    dArr[i] = MenuHostHelper$$ExternalSyntheticLambda0(d6, d7, d8, d9, dArr5[i6][i], dArr5[i8][i]);
                    i++;
                }
                return;
            }
    ...
    public final void setX(double d, float[] fArr) {
        ...
        if (this.setIconTintList) {
            ...
            if (d <= d2) {
                MenuHostHelper$$ExternalSyntheticLambda1(d2, this.setX);
                for (int i2 = 0; i2 < length2; i2++) {
                    fArr[i2] = (float) (this.MenuHostHelper$$ExternalSyntheticLambda1[0][i2] + ((d - this.setY[0]) * this.setX[i2]));
                }
                return;
            }
            int i3 = length - 1;
            ...
            if (d >= d3) {
                MenuHostHelper$$ExternalSyntheticLambda1(d3, this.setX);
                while (i < length2) {
                    fArr[i] = (float) (this.MenuHostHelper$$ExternalSyntheticLambda1[i3][i] + ((d - this.setY[i3]) * this.setX[i]));
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.MenuHostHelper$$ExternalSyntheticLambda0;
                    fArr[i] = (float) MenuHostHelper$$ExternalSyntheticLambda0(d6, d7, d8, d9, dArr4[i6][i], dArr4[i8][i]);
                    i++;
                }
                return;
            }
    ...
    public final double MenuHostHelper$$ExternalSyntheticLambda0(double d) {
        ...
        while (i3 < length - 1) {
            ...
            if (d < d7) {
                ...
                double[][] dArr4 = this.MenuHostHelper$$ExternalSyntheticLambda0;
                return MenuHostHelper$$ExternalSyntheticLambda0(d8, d9, d10, d11, dArr4[i3][0], dArr4[i4][0]);
            }
            i3 = i4;
        }
        return 0.0d;
        ...
        while (i < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                for (int i3 = 0; i3 < length2; i3++) {
                    ...
                    double[][] dArr5 = this.MenuHostHelper$$ExternalSyntheticLambda0;
                    dArr[i3] = MenuHostHelper$$ExternalSyntheticLambda1(d5, d6, d7, d8, dArr5[i][i3], dArr5[i2][i3]) / d5;
                }
                return;
            }
            i = i2;
    ...
    public final double setY(double d, int i) {
        double[] dArr = this.setY;
        int length = dArr.length;
        double d2 = dArr[0];
        if (d >= d2) {
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                double[][] dArr4 = this.MenuHostHelper$$ExternalSyntheticLambda0;
                return MenuHostHelper$$ExternalSyntheticLambda1(d5, d6, d7, d8, dArr4[i2][0], dArr4[i3][0]) / d5;
            }
            i2 = i3;
        }
        return 0.0d;
