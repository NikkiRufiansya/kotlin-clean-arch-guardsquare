...
final class C0072cf {
    final FileChannel setIconTintList;
    final FileLock setY;

    private C0072cf(FileChannel fileChannel, FileLock fileLock) {
        this.setIconTintList = fileChannel;
        this.setY = fileLock;
    }
    ...
    */
    public static o.C0072cf setIconTintList(android.content.Context r4, java.lang.String r5) {
        /*
            r0 = 0
            ...
            o.cf r1 = new o.cf     // Catch: java.nio.channels.OverlappingFileLockException -> L1f java.lang.Error -> L21 java.io.IOException -> L23
        ...
        L48:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: o.C0072cf.setIconTintList(android.content.Context, java.lang.String):o.cf");
    }
}